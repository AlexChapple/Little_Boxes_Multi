...
function RK4(Ω, λL, λR, dt, η_0_old, ξ_0_old, η_1_old, ξ_1_old, η_2_old, ξ_2_old)
    ...
    η_0_new = η_0_old + (dt/6)*(η_0_k1 + 2*η_0_k2 + 2*η_0_k3 + η_0_k4)
    ξ_0_new = ξ_0_old + (dt/6)*(ξ_0_k1 + 2*ξ_0_k2 + 2*ξ_0_k3 + ξ_0_k4)

    η_1_new = η_1_old + (dt/6)*(η_1_k1 + 2*η_1_k2 + 2*η_1_k3 + η_1_k4)
    ξ_1_new = ξ_1_old + (dt/6)*(ξ_1_k1 + 2*ξ_1_k2 + 2*ξ_1_k3 + ξ_1_k4)

    η_2_new = η_2_old + (dt/6)*(η_2_k1 + 2*η_2_k2 + 2*η_2_k3 + η_2_k4)
    ξ_2_new = ξ_2_old + (dt/6)*(ξ_2_k1 + 2*ξ_2_k2 + 2*ξ_2_k3 + ξ_2_k4)
...
function plot_results(time_list, avg_spin_down, avg_spin_up, Ω, γL, γR, phase, N, end_time, time_steps, num_of_simulations)
    ...
    name = "Figures/spin_down_RK4.png"
    savefig(name)
